...
const CARDS: FeatureCard[] = [
  {
    ...
    title:       "Personalized AI Rankings",
    description: "Our neural engine analyzes your playstyle to predict your next obsession with 98% accuracy.",
  },
  {
    icon:        "sync",
    ...
    title:       "Real-time Library Sync",
    description: "Connect Steam, Epic, and PSN instantly. Track progress across every platform in one HUD.",
    offset:      true,
  },
  {
    icon:        "groups",
    ...
    description: "Real-time sentiment analysis from the core of the gaming world. Know what's hot before it's news.",
    livePulse:   true,
  },
];
